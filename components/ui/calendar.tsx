    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 hover:bg-slate-100"
        ),
        ...
        day_selected:
          "bg-slate-200 text-slate-900 hover:bg-slate-200 hover:text-slate-900 focus:bg-slate-200 focus:text-slate-900",
